...
public class Constants {
    ...
    public static final String WelcomeMessage = "Welcome to Employee Manager";
    public static final String SearchHint = "Search here...";
    public static final String EmployeeInfoLabel = "Employee info";
    public static final String DeleteEmployeeLabel = "Delete employee?";
    public static final String CallEmployeeLabel = "Call employee";
    public static final String DeleteLabel = "Delete";
    public static final String EditLabel = "Edit";
